...
import { addWalletAction, exchangeExpensesThunk, addWalletValueEdit } from '../redux/actions';
...
class WalletForm extends Component {
  ...
  saveExpenses = (event) => {
    ...
    if (editor) {
      let { expenses, idToEdit } = walletState;
      editor = false;
      const exchangeRates = expenses[idToEdit].exchangeRates;
